...
function signupAction(prevFormState, formData) {
    ...
    const enteredValues = {
        ...
        lastName, role, terms, acquisitionChannel
    };

    console.log("ACTION: Отримано дані:", enteredValues);
    ...
    console.log("ACTION: Валідація успішна!");
    return { errors: null };
}
...
export default function Signup() {
    ...
    console.log("COMPONENT RENDER: Поточний стан:", {
        errors: formState.errors,
        values: formState.enteredValues
    });
